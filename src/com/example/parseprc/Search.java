...
public class Search extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		final EditText book1;
		final Button Search;
		
		book1=(EditText)findViewById(R.id.searchbar);
		...
		stext=book1.getText().toString();
		Log.v("Stringentered",stext);
	            }
		 });
	}
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
	 ...
	 private class RemoteDataTask extends AsyncTask<Void, Void, Void> {
 		...
 		protected Void doInBackground(Void... params) {
 			...
 			final EditText book1=(EditText)findViewById(R.id.searchbar);
 			String text1=book1.getText().toString();
 			Log.v("booknme",text1);
 			try {
 				...
 				// by ascending
 				query.whereEqualTo("book_name",text1);
 		...
 		protected void onPostExecute(Void result) {
 			...
 			adapter = new ListViewAdapter(Search.this,
 					worldpopulationlist);
